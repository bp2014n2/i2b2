...
model.observations.data=sample(0:1,model.observations.total*feature.total,replace=TRUE)
model.target.data=sample(0:1,model.observations.total,replace=TRUE)
newdata.observations.data=sample(0:1,newdata.observations.total*feature.total,replace=TRUE)
