...
import de.erlangen.i2b2.giri.datavo.pdo.ConceptType;
import de.erlangen.i2b2.giri.datavo.pdo.EventSet;
import de.erlangen.i2b2.giri.datavo.pdo.EventType;
import de.erlangen.i2b2.giri.datavo.pdo.ModifierSet;
import de.erlangen.i2b2.giri.datavo.pdo.ModifierType;
import de.erlangen.i2b2.giri.datavo.pdo.ObservationSet;
import de.erlangen.i2b2.giri.datavo.pdo.ObservationType;
import de.erlangen.i2b2.giri.datavo.pdo.ObserverSet;
import de.erlangen.i2b2.giri.datavo.pdo.ObserverType;
import de.erlangen.i2b2.giri.datavo.pdo.ParamType;
import de.erlangen.i2b2.giri.datavo.pdo.PatientSet;
import de.erlangen.i2b2.giri.datavo.pdo.PatientType;
...
public class CRCResponseParser {
	...
	private static String SEP = GIRIUtil.SEP;
	
	public static GIRICSVContainer parsePatientSet(PatientSet crcPS) {
		...
		if (empty) return new GIRICSVContainer(psSB.toString(), false);
		else return new GIRICSVContainer(psSB.toString(), true);
	}
	
	public static GIRICSVContainer parseObservationSet(ObservationSet crcOS, ConceptSet crcCS) {
		...
		if (empty) return new GIRICSVContainer(osSB.toString(), false);
		else return new GIRICSVContainer(osSB.toString(), true);
	}
	
	public static GIRICSVContainer parseModifierSet(ModifierSet crcMS) {
		boolean empty = true;
		...
		if (empty) return new GIRICSVContainer(msSB.toString(), false);
		else return new GIRICSVContainer(msSB.toString(), true);
	}
	
	public static GIRICSVContainer parseEventSet(EventSet crcES) {
		boolean empty = true;
		// Build modifier set csv string
		...
		if (empty) return new GIRICSVContainer(esSB.toString(), false);
		else return new GIRICSVContainer(esSB.toString(), true);
	}
	
	public static GIRICSVContainer parseObserverSet(ObserverSet crcObS) {
		boolean empty = true;
		// Build modifier set csv string
		...
		if (empty) return new GIRICSVContainer(obsSB.toString(), false);
		else return new GIRICSVContainer(obsSB.toString(), true);
	}
