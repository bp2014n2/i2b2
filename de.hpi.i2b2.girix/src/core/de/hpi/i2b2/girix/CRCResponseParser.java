...
import de.hpi.i2b2.girix.datavo.pdo.ConceptType;
import de.hpi.i2b2.girix.datavo.pdo.EventSet;
import de.hpi.i2b2.girix.datavo.pdo.EventType;
import de.hpi.i2b2.girix.datavo.pdo.ModifierSet;
import de.hpi.i2b2.girix.datavo.pdo.ModifierType;
import de.hpi.i2b2.girix.datavo.pdo.ObservationSet;
import de.hpi.i2b2.girix.datavo.pdo.ObservationType;
import de.hpi.i2b2.girix.datavo.pdo.ObserverSet;
import de.hpi.i2b2.girix.datavo.pdo.ObserverType;
import de.hpi.i2b2.girix.datavo.pdo.ParamType;
import de.hpi.i2b2.girix.datavo.pdo.PatientSet;
import de.hpi.i2b2.girix.datavo.pdo.PatientType;
...
public class CRCResponseParser {
	...
	private static String SEP = GIRIXUtil.SEP;
	
	public static GIRIXCSVContainer parsePatientSet(PatientSet crcPS) {
		...
		if (empty) return new GIRIXCSVContainer(psSB.toString(), false);
		else return new GIRIXCSVContainer(psSB.toString(), true);
	}
	
	public static GIRIXCSVContainer parseObservationSet(ObservationSet crcOS, ConceptSet crcCS) {
		...
		if (empty) return new GIRIXCSVContainer(osSB.toString(), false);
		else return new GIRIXCSVContainer(osSB.toString(), true);
	}
	
	public static GIRIXCSVContainer parseModifierSet(ModifierSet crcMS) {
		boolean empty = true;
		...
		if (empty) return new GIRIXCSVContainer(msSB.toString(), false);
		else return new GIRIXCSVContainer(msSB.toString(), true);
	}
	
	public static GIRIXCSVContainer parseEventSet(EventSet crcES) {
		boolean empty = true;
		// Build modifier set csv string
		...
		if (empty) return new GIRIXCSVContainer(esSB.toString(), false);
		else return new GIRIXCSVContainer(esSB.toString(), true);
	}
	
	public static GIRIXCSVContainer parseObserverSet(ObserverSet crcObS) {
		boolean empty = true;
		// Build modifier set csv string
		...
		if (empty) return new GIRIXCSVContainer(obsSB.toString(), false);
		else return new GIRIXCSVContainer(obsSB.toString(), true);
	}
