...
import de.hpi.i2b2.report.datavo.reportmessages.InputParameterType;
...
public class ReportUtil {
    ...
    private static final String[] DEFAULT_PACKAGE_NAME = new String[] {
        "de.hpi.i2b2.report.datavo.i2b2message",
        "de.hpi.i2b2.report.datavo.pdo",
        "de.hpi.i2b2.report.datavo.pdo.query",
	...
	public static RscriptletType validateAndUnmarshallScriptletConfigFile(String scriptletPath, String scriptletName) throws I2B2Exception, SAXException {
		...
		if (scriptletconfig.exists()) {
			...
			try {
				reportType = (RscriptletType) getJAXBUtil().unMashallerRequest(scriptletconfigpath).getValue();
				if (reportType == null) throw new NullPointerException();
			} catch (Exception e) {
