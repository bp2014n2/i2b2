/**
 * @projectDescription	Messages to configure and build a GIRIX cell communicator object.
 * @namespace	i2b2.GIRIX.ajax
 * @author		Bastian Weinlich
 * @version 	0.1
 */

// create the communicator Object
i2b2.GIRIX.ajax = i2b2.hive.communicatorFactory("GIRIX");

// create namespaces to hold all the communicator messages and parsing routines
i2b2.GIRIX.cfg.msgs = {};
i2b2.GIRIX.cfg.parsers = {};


// ================================================================================================== //
// URL: Address: http://localhost:9090/i2b2/rest/GIRIXService/getRScriptlets
i2b2.GIRIX.cfg.msgs.getRScriptlets = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n'+
...
'			<application_name>GIRIX Cell</application_name>\n'+
...
i2b2.GIRIX.cfg.parsers.getRScriptlets = function(){
	if (!this.error) {
		this.model = [];
...
i2b2.GIRIX.ajax._addFunctionCall("getRScriptlets","{{{URL}}}getRScriptlets",i2b2.GIRIX.cfg.msgs.getRScriptlets,null,i2b2.GIRIX.cfg.parsers.getRScriptlets);



// ================================================================================================== //
// URL: Address: http://localhost:9090/i2b2/rest/GIRIXService/getRResults
i2b2.GIRIX.cfg.msgs.getRResults = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n'+
'<ns4:request xmlns:ns4="http://www.i2b2.org/xsd/hive/msg/1.1/"  xmlns:ns2="http://www.i2b2.org/xsd/cell/girix/1.0/" xmlns:ns3="http://www.i2b2.org/xsd/cell/crc/pdo/1.1/">\n'+
'	<message_header>\n'+
'		{{{proxy_info}}}\n'+
'		<i2b2_version_compatible>1.1</i2b2_version_compatible>\n'+
...
'	</message_body>\n'+
'</ns4:request>';
i2b2.GIRIX.cfg.parsers.getRResults = function(){
	if (!this.error) {
		this.model = [];
...
i2b2.GIRIX.ajax._addFunctionCall("getRResults","{{{URL}}}getRResults",i2b2.GIRIX.cfg.msgs.getRResults,["patient_sets", "additional_input", "concepts"],i2b2.GIRIX.cfg.parsers.getRResults);
