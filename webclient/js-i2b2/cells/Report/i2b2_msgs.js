/**
 * @projectDescription	Messages to configure and build a GIRI cell communicator object.
 * @namespace	i2b2.GIRI.ajax
 * @author		Bastian Weinlich
 * @version 	0.1
 */

// create the communicator Object
i2b2.GIRI.ajax = i2b2.hive.communicatorFactory("GIRI");

// create namespaces to hold all the communicator messages and parsing routines
i2b2.GIRI.cfg.msgs = {};
i2b2.GIRI.cfg.parsers = {};


// ================================================================================================== //
// URL: Address: http://localhost:9090/i2b2/rest/GIRIService/getRScriptlets
i2b2.GIRI.cfg.msgs.getRScriptlets = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n'+
...
'			<application_name>GIRI Cell</application_name>\n'+
...
i2b2.GIRI.cfg.parsers.getRScriptlets = function(){
	if (!this.error) {
		this.model = [];
...
i2b2.GIRI.ajax._addFunctionCall("getRScriptlets","{{{URL}}}getRScriptlets",i2b2.GIRI.cfg.msgs.getRScriptlets,null,i2b2.GIRI.cfg.parsers.getRScriptlets);



// ================================================================================================== //
// URL: Address: http://localhost:9090/i2b2/rest/GIRIService/getRResults
i2b2.GIRI.cfg.msgs.getRResults = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n'+
'<ns4:request xmlns:ns4="http://www.i2b2.org/xsd/hive/msg/1.1/"  xmlns:ns2="http://www.i2b2.org/xsd/cell/giri/1.0/" xmlns:ns3="http://www.i2b2.org/xsd/cell/crc/pdo/1.1/">\n'+
'	<message_header>\n'+
'		{{{proxy_info}}}\n'+
'		<i2b2_version_compatible>1.1</i2b2_version_compatible>\n'+
...
'	</message_body>\n'+
'</ns4:request>';
i2b2.GIRI.cfg.parsers.getRResults = function(){
	if (!this.error) {
		this.model = [];
...
i2b2.GIRI.ajax._addFunctionCall("getRResults","{{{URL}}}getRResults",i2b2.GIRI.cfg.msgs.getRResults,["patient_sets", "additional_input", "concepts"],i2b2.GIRI.cfg.parsers.getRResults);
